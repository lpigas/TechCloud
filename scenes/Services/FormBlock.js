    ...
    <>
      ...
      <div className={`absolute top-[378px] left-[974px]`}>
        <ServicesForms
          ...
          bigImage={"/image/Form/bigImage/outsorc.svg"}
        />
      </div>
      ...
      <div className={`absolute top-[812px] left-[974px]`}>
        <ServicesForms
          ...
          bigImage={"/image/Form/bigImage/clouds.svg"}
        />
      </div>
      <div className={`absolute top-[1248px] left-[368px]`}>
        <ServicesForms
          ...
          bigImage={"/image/Form/bigImage/security.svg"}
        />
      </div>
      ...
      <div className={`absolute top-[1684px] left-[368px]`}>
        <ServicesForms
          ...
          bigImage={"/image/Form/bigImage/soft.svg"}
        />
      </div>
      <div className={`absolute top-[1684px] left-[974px]`}>
        <ServicesForms
          ...
          bigImage={"/image/Form/bigImage/cloud_soft.svg"}
        />
      </div>
    </>
  );

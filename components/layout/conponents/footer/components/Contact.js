...
export default function Contact() {
  return (
    <div>
      ...
      <div className=" mt-[22px] font-normal not-italic text-[18px] leading-[36px] w-[276px] h-[71px] text-[#616E87]">
        <p>Звоните нам:</p>
        <p className="text-[22px] text-[#3E3F50] font-bold">
          +38(048)788 78 33
        </p>
      </div>
      <div className="mt-[26px] font-normal not-italic text-[18px] leading-[36px] w-[276px] h-[71px] text-[#616E87]">
        <p>или пишите:</p>
